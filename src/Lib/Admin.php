		...
		<div class="securefusion-dashboard container">
			...
			<section class="dashboard-overview">
				<div class="dashboard-item">
					...
					<p><?php esc_html_e( 'WordPress Version:', 'securefusion' ); echo ' ' . $wp_version; ?></p>

					<?php
						if ( version_compare( $wp_version, '6.4.2', '<' ) ) :
							$security_pass = false;
					?>
						<p class="status disabled"><?php esc_html_e( 'Your WordPress version has security vulnurabilities.', 'securefusion' ); ?></p>
					<?php endif; ?>

					<p><?php esc_html_e( 'PHP Version:', 'securefusion' ); echo ' ' . phpversion(); ?></p>

					<?php
						if ( version_compare( phpversion(), '8.3.0', '<' ) ) :
							$security_pass = false;
					?>
						<p class="status disabled"><?php esc_html_e( 'Your PHP version has security vulnurabilities.', 'securefusion' ); ?></p>
					<?php endif; ?>

					<p><?php esc_html_e( 'Failed login attempts:', 'securefusion' ); echo ' ' . (int) $total_attempts; ?></p>
					<p><?php esc_html_e( 'IPs of Failed Attempts:', 'securefusion' ); echo ' ' . (int) $unique_ips_count; ?></p>
	...
	public function load()
	{
		...
		$conf = [
            ...
            [
				...
				'desc'	=> esc_html__( 'Advanced security settings. `Filter Bad Requests` must be active for it to work. Separated by lines. For example: [a-z0-9]+/#[a-z]*', 'securefusion' ),
				// Form items
				'items' => [
					[
						'type'		=> 'textarea',
